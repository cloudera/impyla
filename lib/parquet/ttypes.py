...
class DictionaryPageHeader:
  ...
  def __init__(self, num_values=None,):
    self.num_values = num_values
...
class PageHeader:
  ...
  Attributes:
   - type
   - uncompressed_page_size: Uncompressed page size in bytes *
   - compressed_page_size: Compressed page size in bytes *
...
class ColumnMetaData:
  ...
  whether we can decode those pages. *
   - path_in_schema: Path in FileMetaData.schema *
   - codec: Compression codec *
   - num_values: Number of values in this column *
   - total_uncompressed_size: total byte size of all uncompressed pages in this column chunk *
   - total_compressed_size: total byte size of all compressed pages in this column chunk *
...
class RowGroup:
  ...
  def __init__(self, columns=None, total_byte_size=None, num_rows=None,):
...
class FileMetaData:
  ...
  def __init__(self, version=None, schema=None, num_rows=None, row_groups=None, key_value_metadata=None,):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i32 in xrange(_size28):
            _elem33 = SchemaElement()
            _elem33.read(iprot)
            self.schema.append(_elem33)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        ...
        if ftype == TType.LIST:
          ...
          for _i38 in xrange(_size34):
            _elem39 = RowGroup()
            _elem39.read(iprot)
            self.row_groups.append(_elem39)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.LIST:
          ...
          for _i44 in xrange(_size40):
            _elem45 = KeyValue()
            _elem45.read(iprot)
            self.key_value_metadata.append(_elem45)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.key_value_metadata is not None:
      ...
      oprot.writeListBegin(TType.STRUCT, len(self.key_value_metadata))
      for iter48 in self.key_value_metadata:
        iter48.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
