...
class TTypeNode(object):
    ...
    thrift_spec = (
        ...
        (3, TType.LIST, 'struct_fields', (TType.STRUCT, (TStructField, TStructField.thrift_spec), False), None, ),  # 3
    )
...
class TColumnType(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'types', (TType.STRUCT, (TTypeNode, TTypeNode.thrift_spec), False), None, ),  # 1
    )
...
class TFunction(object):
    ...
    thrift_spec = (
        ...
        (3, TType.LIST, 'arg_types', (TType.STRUCT, (TColumnType, TColumnType.thrift_spec), False), None, ),  # 3
