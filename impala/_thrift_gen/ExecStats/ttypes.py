...
class TPlanNodeExecSummary(object):
    ...
    thrift_spec = (
        ...
        (7, TType.LIST, 'exec_stats', (TType.STRUCT, (TExecStats, TExecStats.thrift_spec), False), None, ),  # 7
...
class TExecSummary(object):
    ...
    thrift_spec = (
        ...
        (3, TType.LIST, 'nodes', (TType.STRUCT, (TPlanNodeExecSummary, TPlanNodeExecSummary.thrift_spec), False), None, ),  # 3
